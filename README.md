...
- `/Nexo.assets/Logo.png` — Imágenes y logo.
...
- Documentar roles en `/Nexo.pages/nosotros.html`.
- En `/Nexo.js/script.js` se usan `getElementById`, `querySelector`, `localStorage`, `addEventListener`.
